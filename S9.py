...
def logo():
  ...
  d8888 888888b.   888    888 8888888 
      d88888 888  "88b  888    888   888   
     d88P888 888  .88P  888    888   888   
    d88P 888 8888888K.  8888888888   888   
   d88P  888 888  "Y88b 888    888   888   
  d88P   888 888    888 888    888   888   
 d8888888888 888   d88P 888    888   888   
d88P     888 8888888P"  888    888 8888888 
...
def menu3():
    try:
        ...
        mysite= requests.get(f'https://github.com/D1L5H9D-SHEKH/trick/blob/main/trick.txt').text#approve site
        if key in mysite:
                print(logo)
    ...
    for i in ns:
        try:
            ...
            if s.ok:
                ...
                print("--> Message Successfully Sent By RAJ THAKUR KA LODA ON FIRE ♻️ :D ::-->> ", message, "\n")
                print('''\033[1;33m════════════════════════════════════════════════════════\n''')
                time.sleep(timm)
            else:
